...
class _HomeState extends State<Home> {
  ...
  Future<T> _navigateToDetail<T extends Object>(Donation donation) =>
      _navigation.push(Detail(donation: donation));

  Future<T> _navigateToLogin<T extends Object>() => _navigation.push(Login());

  Future<T> _showLogoutConfirmationDialog<T extends Object>() => showDialog<T>(
      context: context,
